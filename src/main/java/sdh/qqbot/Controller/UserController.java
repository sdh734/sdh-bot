...
public class UserController {
    ...
    public static User getUserByQQ(String userQQ) {
        User user = userService.getOne(new QueryWrapper<User>().eq("user_id", userQQ));
//        if (user != null) {
//            return user;
//        } else {
//            User user1 = new User();
//            user1.setUserId(userQQ);
//            addUser(user1);
//            user = userService.getOne(new QueryWrapper<User>().eq("user_id", userQQ));
//            return user;
//        }
        return user;
    }
