    ...
    public static void sendSexPicture(MessageEntity message) {
        ...
        if (baseUrl != null) {
            ...
            if (img.getData().size() != 0) {
                ...
                QBotSendMessageController.sendMsg(message, errorMessage,null);
            }
        } else {
