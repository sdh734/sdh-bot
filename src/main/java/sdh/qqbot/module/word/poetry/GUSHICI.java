package sdh.qqbot.module.word.poetry;
...
public class GUSHICI {
    ...
    public static void gushiManager(MessageEntity message) {
        ...
        if (msgArr.length > 1 && msgArr[1] != null) {
            ...
            QBotSendMessageController.sendMsg(message, gushiEntity.toString(),null);
        } else {
    ...
    private static String help() {
        ...
        builder.append("古诗词一言帮助：").append("\n");
        builder.append("古诗词 古诗类型(可选，默认全部，具体查看下表：)").append("\n");
        for (String key : keys) {
