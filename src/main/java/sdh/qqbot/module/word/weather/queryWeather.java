package sdh.qqbot.module.word.weather;
...
import sdh.qqbot.utils.werther.formatWeatherInfo;
...
public class queryWeather {
    ...
    private static void queryWeatherByCityString(MessageEntity message, String city) {
        ...
        QBotSendMessageController.sendMsg(message, formatWeatherInfo.format(weatherEntity, 2, weatherCityEntity.getGeocodes().get(0).getFormattedAddress()),null);
    }
    ...
    private static void queryWeatherByCityStringAndDayCount(MessageEntity message, String city, int dayCount) {
        ...
        //根据经纬度查询天气
        WeatherEntity weatherEntity = QueryApiManagerController.queryWeatherByLocation(weatherCityEntity.getGeocodes().get(0).getLocation());
        QBotSendMessageController.sendMsg(message, formatWeatherInfo.format(weatherEntity, dayCount, weatherCityEntity.getGeocodes().get(0).getFormattedAddress()),null);
    }
