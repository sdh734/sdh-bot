...
public class NcovInfo {
    public static void NcovInfoManager(MessageEntity message) {
        ...
        if (msgArr.length == 1) {
            ...
            QBotSendMessageController.sendMsg(message, "[CQ:image,file=file:///" + path + ",id=40000]",null);
        }
    ...
    private static void help(MessageEntity message) {
        String stringBuilder = "疫情功能帮助：\n" + "疫情 [关键词] 关键词为地址参数，可为省份、市级";
